...
const Hero = () => {
  return (
    <section className="bg-black min-h-screen flex flex-col items-center justify-center relative text-white pt-[80px]">
      ...
      <section className="container relative h-full flex flex-col gap-6 items-center justify-center">
        <h1 data-aos="fade-down" data-aos-duration="1500" >TECH DAY</h1>

        <p data-aos-duration="1500" data-aos="fade-up" className="max-w-[480px] text-center mb-[47px]">
